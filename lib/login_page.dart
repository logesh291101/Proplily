...
import 'package:proplilly/services/login_service.dart';
import 'package:proplilly/forgot_password_page.dart';
import 'package:proplilly/home_page.dart';
import 'package:proplilly/signup_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _handleLogin() async {
    ...
    switch (result) {
      case LoginSuccess(:final message):
