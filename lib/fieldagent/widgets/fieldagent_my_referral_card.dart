...
import 'package:proplilly/fieldagent/fieldagent_referral_list_extensions.dart';
import 'package:proplilly/fieldagent/fieldagent_referral_list_model.dart';

class FieldAgentMyReferralCard extends StatelessWidget {
  const FieldAgentMyReferralCard({
    super.key,
    required this.referral,
  });

  final FieldAgentReferral referral;
