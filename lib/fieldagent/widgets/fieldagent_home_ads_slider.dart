...
import 'package:proplilly/fieldagent/fieldagent_ad_details_screen.dart';
import 'package:proplilly/fieldagent/fieldagent_ads_model.dart';
import 'package:proplilly/fieldagent/widgets/fieldagent_ad_interest_dialog.dart';

/// Auto-sliding ads banner for the Field Agent home screen.
class FieldAgentHomeAdsSlider extends StatefulWidget {
  const FieldAgentHomeAdsSlider({
    super.key,
    required this.ads,
  });

  final List<FieldAgentAdData> ads;

  @override
  State<FieldAgentHomeAdsSlider> createState() =>
      _FieldAgentHomeAdsSliderState();
}

class _FieldAgentHomeAdsSliderState extends State<FieldAgentHomeAdsSlider> {
  ...
  @override
  void didUpdateWidget(FieldAgentHomeAdsSlider oldWidget) {
  ...
  void _openAdDetails(FieldAgentAdData ad) {
    ...
    Navigator.of(context).push<void>(
      MaterialPageRoute<void>(
        builder: (_) => FieldAgentAdDetailsScreen(
          adId: adId,
          ad: ad,
        ),
      ),
  ...
  void _openInterestDialog(FieldAgentAdData ad) {
    showFieldAgentAdInterestDialog(context, ad: ad);
  }
