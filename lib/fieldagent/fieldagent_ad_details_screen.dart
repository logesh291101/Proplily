...
class FieldAgentAdDetailsScreen extends StatefulWidget {
  const FieldAgentAdDetailsScreen({
    super.key,
    required this.adId,
    required this.ad,
  });
  ...
  @override
  State<FieldAgentAdDetailsScreen> createState() =>
      _FieldAgentAdDetailsScreenState();
}

class _FieldAgentAdDetailsScreenState extends State<FieldAgentAdDetailsScreen> {
  late final PageController _imageController;
  int _currentImageIndex = 0;

  FieldAgentAdData get ad => widget.ad;
          ...
          children: [
            ...
            if (ctaLabel != null && ctaLabel.isNotEmpty) ...[
              ...
              PremiumPrimaryButton(
                label: ctaLabel,
                onPressed: () => showFieldAgentAdInterestDialog(
                  context,
                  ad: ad,
                ),
              ),
