...
/// Maps [ClientProfileModel] API data to [UserProfile] for existing profile widgets.
abstract final class ClientProfileMapper {
  static final DateFormat _displayDate = DateFormat('MMM dd, yyyy');

  static UserProfile? toUserProfile(ClientProfileModel model) {
  ...
  static String _formatPhone(ClientData data) {
  ...
  static String _renewalLabel(ClientData data) {
  ...
  static List<ActivityItem> _buildActivities(ClientData data) {
    ...
    if (lastLogin.isNotEmpty) {
      items.add(
        ActivityItem(
          ...
          title: 'Last Login',
          description: data.lastIp.trim().isNotEmpty
    ...
    if (referredAt != null && referredAt.isNotEmpty) {
      items.add(
        ActivityItem(
          ...
          title: 'Referral',
          description: data.ownReferralCode.trim().isNotEmpty
