...
import 'package:proplilly/client/screens/client_profile_screen.dart';
import 'package:proplilly/client/widgets/client_home/client_home_dashboard_body.dart';
import 'package:proplilly/client/widgets/client_home/client_home_welcome_header.dart';
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (_) => ClientHomePropertiesProvider()..loadProperties(),
        ),
        ChangeNotifierProvider(
...
class _HomePageViewState extends State<_HomePageView> {
  ...
  static const List<({String label, IconData icon})> _menuItems = [
    ...
    (label: 'My Properties', icon: Icons.home_work_outlined),
    (label: 'Add Property', icon: Icons.add_home),
    (label: 'Property Status', icon: Icons.visibility),
    (label: 'Visit Reports', icon: Icons.assignment_outlined),
  ...
  Future<void> _onLogoutTapped() async {
    ...
    try {
      ...
      ClientNotificationProvider.reset();
