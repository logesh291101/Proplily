...
import 'package:proplilly/providers/client_support_ticket_provider.dart';
import 'package:proplilly/services/client_support_ticket_service.dart';
...
import 'package:proplilly/widgets/client_support_ticket/client_support_ticket_assistance_card.dart';
import 'package:proplilly/widgets/client_support_ticket/client_support_ticket_category_field.dart';
import 'package:proplilly/widgets/client_support_ticket/client_support_ticket_hero_section.dart';
...
class ClientSupportTicketScreen extends StatelessWidget {
  const ClientSupportTicketScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => ClientSupportTicketProvider(),
      child: const _ClientSupportTicketView(),
    );
  }
}

class _ClientSupportTicketView extends StatefulWidget {
  const _ClientSupportTicketView();

  @override
  State<_ClientSupportTicketView> createState() => _ClientSupportTicketViewState();
}

class _ClientSupportTicketViewState extends State<_ClientSupportTicketView> {
  ...
  Future<void> _onSubmit() async {
    ...
    final result = await context.read<ClientSupportTicketProvider>().submitTicket(
  ...
  Widget build(BuildContext context) {
    ...
    final isSubmitting = context.watch<ClientSupportTicketProvider>().isSubmitting;

    return Scaffold(
      backgroundColor: AppColors.background,
      body: Column(
        children: [
          const ClientSupportTicketHeroSection(),
          Expanded(
...
class _SubmitTicketCard extends StatelessWidget {
  const _SubmitTicketCard({
