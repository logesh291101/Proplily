...
class CoordinatorAddPropertyScreen extends StatefulWidget {
  const CoordinatorAddPropertyScreen({super.key});

  @override
  State<CoordinatorAddPropertyScreen> createState() => _CoordinatorAddPropertyScreenState();
}

class _CoordinatorAddPropertyScreenState extends State<CoordinatorAddPropertyScreen> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(child: Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Add Property (Coordinator)'),
      ),
      body: Form(
        key: _formKey,
